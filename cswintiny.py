...
class CSWinBlock(nn.Module):
    ...
    def __init__(self, dim, patches_resolution, num_heads,
                 split_size=2, mlp_ratio=4., qkv_bias=False, qk_scale=None,
...
class CSWin(nn.Module):
    ...
    """
    def __init__(self, img_size=16,  in_chans=128, embed_dim=256,  split_size = 2,
        ...
        self.tranformer = \
            CSWinBlock(
                dim=curr_dim,num_heads=heads,patches_resolution=16//1,mlp_ratio=mlp_ratio,
