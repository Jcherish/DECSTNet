...
class Downsample(nn.Module):  #调用
    def __init__(self,wavename='sym6'):
...
class WRANet(nn.Module):
    ...
    def __init__(self, img_ch=3, output_ch=1,wavename='sym6'):
        super(WRANet, self).__init__()
        ...
        self.Maxpool1 = Downsample(wavename=wavename)
        self.Maxpool2 = Downsample(wavename=wavename)
        self.Maxpool3 = Downsample(wavename=wavename)
        self.Maxpool4 = Downsample(wavename=wavename)
